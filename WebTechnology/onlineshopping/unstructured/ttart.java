...
public class ttart extends HttpServlet
{
	...
	try
	{
		...
		String qry="select artist1 from music  group by artist1 order by sum(nocs) desc ";
		rs=stmt.executeQuery(qry);
		pw.println("<br>");
		pw.println("<pre><b><font size=6>"+"\t\t\t"+"<u>"+"TOP TEN ARTISTS"+"</pre></u></b></font>");
		pw.println("<form  action=http://localhost:8080/servlet/ttart1 method=get>");
