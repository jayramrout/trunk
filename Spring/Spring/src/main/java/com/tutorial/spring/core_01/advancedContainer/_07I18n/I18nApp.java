package com.tutorial.spring.core_01.advancedContainer._07I18n;
...
public class I18nApp {
	public static void main(String args[]) {
		...
		// ResourceBundle r =
		// ResourceBundle.getBundle("com/tutorial/core_01/advancedContainer/_07I18n/app");

		Locale locale = new Locale("en");
//		 Locale locale = new Locale("fr","be");
		ResourceBundle r = ResourceBundle
				.getBundle(
						"com/tutorial/spring/core_01/advancedContainer/_07I18n/app",
						locale);
