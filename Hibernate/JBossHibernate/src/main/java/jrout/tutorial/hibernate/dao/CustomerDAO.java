...
import jrout.tutorial.hibernate.model.Customer;
 ...
 * @see jrout.tutorial.hibernate.model.Customer
...
public class CustomerDAO extends BaseDAO {
	...
	public Customer findById(jrout.tutorial.hibernate.model.CustomerId id) {
		log.debug("getting Customer instance with id: " + id);
		try {
			Customer instance = (Customer) getSession()
					.get("jrout.tutorial.hibernate.model.Customer", id);
			if (instance == null) {
	...
	public List findByExample(Customer instance) {
		...
		try {
			List results = getSession()
					.createCriteria("jrout.tutorial.hibernate.model.Customer")
